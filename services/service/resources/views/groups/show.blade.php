<x-sidebar-layout>
    <x-slot name="sidebar">
        ...
        <div class="border-b border-gray-200 hover:opacity-75">
            <a class="text-sm p-4 block" href="{{ route('groups.edit', 1) }}">
                ...
                <div class="p-4 max-w-4xl m-auto">
                    <div class="mb-4">
                        ...
                        <div class="bg-white p-2 pr-3 rounded flex">
                            ...
                            <button class="text-sm text-red-400"><i
                    ...
                    <div class="mb-4">
                        <div class="mb-1 ml-1">
                               <span class="text-sm mr-2">
                                   <i class="fa fa-user mr-2"></i>user_is_2
                               </span>
                    ...
                    <div class="p-4 max-w-4xl m-auto">
                        <div class="flex items-center">
                            <div class="flex-1 pr-2">
                                <input type="text" class="w-full p-2 pl-3 pr-3 border rounded" placeholder="Message">
                            </div>
                            <div>
